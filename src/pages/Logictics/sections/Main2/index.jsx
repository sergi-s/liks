...
const Main2 = props => {
  ...
  return (
    <Grid
      container
      sx={{
        padding: '106.8px 153.59px 10px 153.59px'
      }}
      spacing={10}
    >
